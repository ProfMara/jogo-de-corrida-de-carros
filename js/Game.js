class Game {
  ...
  mostrarVida(){
    ...
    // o retângulo branco que fica atrás
    fill("white");
    rect(width/2 -100,height-player.positionY-150, 160, 20);
    //o retângulo vermelho que fica na frente
    fill("red");
  ...
  perdeVida(){
    //verifica se o jogador está pressionando
    // a tecla para esquerda
    if(this.esquerda == true){
      //joga o jogador para a direita
      player.positionX +=100;
    }else{
      //senão, joga o jogador para a esquerda
      player.positionX -=100;
    }
    if(player.life > 0){
      player.life -=40;
